...
static const char *fonts[]          = {"JetBrainsMono Nerd Font Mono:style:medium:size=8" };
...
static const char *colors[][3]      = {
    /*                     fg       bg      border */
    [SchemeNorm]       = { gray3,   black,  "#000000" },
    [SchemeSel]        = { gray4,   blue,   "#ffffff"  },
...
static const Key keys[] = {
    ...
    {MODKEY|ControlMask,                XK_s,       spawn,
        SHCMD("")},
    {MODKEY,                            XK_s,       spawn,
        SHCMD("scrot -s -b ~/Pictures/screenshot_%Y-%m-%d_%H-%M-%S.png")},

    { MODKEY,                           XK_c,       spawn,          SHCMD("rofi -show drun") },
    { MODKEY,                           XK_Return,  spawn,          SHCMD("kitty -1")},
